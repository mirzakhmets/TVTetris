...
class GameViewModel : ViewModel() {
    ...
    var _viewState: MutableState<ViewState> = mutableStateOf(ViewState())
    var viewState : State<ViewState> = _viewState
    ...
    fun actionUp() {
        dispatch(Action.Move(Direction.Up))
    }

    fun actionLeft() {
        dispatch(Action.Move(Direction.Left))
    }

    fun actionRight() {
        dispatch(Action.Move(Direction.Right))
    }

    fun actionDown() {
        dispatch(Action.Move(Direction.Down))
    }
